      ...
      <Grid container spacing={2}>
        <Grid item xs={12} sm={3}>
          <Card sx={{ height: "calc(100vh - 100px )" }}>
            <CardHeader style={{backgroundColor: "#42a5f5", color: "white"}} title="En proceso" />
            <OrdenList status={1} orders={pedidos || []} />
          </Card>
        </Grid>
        <Grid item xs={12} sm={3}>
          <Card sx={{ height: "calc(100vh - 100px )" }}>
            <CardHeader style={{backgroundColor: "#66bb6a", color: "white"}} title="Confirmado" />
        ...
        <Grid item xs={12} sm={3}>
          <Card sx={{ height: "calc(100vh - 100px )" }}>
            <CardHeader style={{backgroundColor: "#ce93d8", color: "white"}} title="Preparando" />
        ...
        <Grid item xs={12} sm={3}>
          <Card sx={{ height: "calc(100vh - 100px )" }}>
            <CardHeader style={{backgroundColor: "#ffa726", color: "white"}} title="Completado" />
