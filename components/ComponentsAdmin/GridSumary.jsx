    ...
    <>
      {isLoading ? (
        ...
        <div className="dash-cardBox">
          <ItemSumary
            number={numactivos}
            name="Pedidos en Local Activos"
            icon="restaurant-outline"
          />
          <ItemSumary
            number={numactivosres}
            name="Pedidos por Reserva Activos"
            icon="calendar-outline"
          />
          <ItemSumary
            number={numactivosdom}
            name="Pedidos a Domicilio Activos"
            icon="home-outline"
          />
          <ItemSumary
            number={numproceso}
          ...
          <ItemSumary
            number={numpend}
            name="Pedidos Pendientes (Reserva)"
