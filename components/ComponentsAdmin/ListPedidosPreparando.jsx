...
const ListPedidosPreparando = ({pedidosLocales,pedidosDomicilio,pedidosReserva}) => {
   
   return (
      <div>
            {
               pedidosLocales.map(pedido => (
                  (pedido.IDSTATE == 3) ?  <><Paper sx={{margin:2}}> <ListItem key={pedido.IDPEDIDO}>
                     <LocalDiningIcon/>
                     ...
                     <div align='center'>
                     <Button variant="outlined" color="warning" sx={{margin:1}}>Completar</Button>
                     </div> </Paper> </>: null
               ))
            }
            {
...
export default ListPedidosPreparando;