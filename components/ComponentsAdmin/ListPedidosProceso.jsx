...
const ListPedidosProceso = ({ pedidosLocales,pedidosDomicilio,pedidosReserva}) => {

   return (
      <div>
            {
               pedidosLocales.map(pedido => (
                  (pedido.IDSTATE == 1) ?  <><Paper sx={{margin:2}}> <ListItem key={pedido.IDPEDIDO}>
                     <LocalDiningIcon/>
                     ...
                     <div align='center'>
                     <Button variant="outlined" color="success" sx={{margin:1}}>Confirmar</Button>
                     </div></Paper> </> : null
               ))
            }
             {
...
export default ListPedidosProceso;